/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 92be5d0d36ae62ab1cd51fbae2d4add2)
// Runtime types generated with workerd@1.20260526.1 2026-05-21 
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	DUMMIES: DurableObjectNamespace<import("./src/index").DummiesParty>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DummiesParty";
	}
